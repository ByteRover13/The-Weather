import { c as create_ssr_component, i as is_promise, n as noop, d as add_attribute, e as escape } from "../../chunks/ssr.js";
const FETCH_OPTIONS = {
  method: "GET",
  headers: {
    "X-RapidAPI-Key": "0e643558f2mshed0adc36d713855p1c70a0jsn3c35cbef6241",
    "X-RapidAPI-Host": "weatherapi-com.p.rapidapi.com"
  }
};
async function getWeatherFrom(query) {
  ...
  return `<head data-svelte-h="svelte-14tzgio"><link rel="icon" href="../static/sun1.png"> <title>The weather</title></head> ${function(__value) {
    ...
    return function(weather) {
      return ` <header class="header"><header class="header"><form><div class="search"><input placeholder="Search Country ..." type="text"${add_attribute("value", inputValue, 0)}> <button type="submit" data-svelte-h="svelte-1k4r6al">Go</button></div></form></header></header> <section><div class="cardm"><div class="card"><svg class="weather" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100px" height="100px" viewBox="0 0 100 100" xml:space="preserve"><image id="image0" width="100" height="100" x="0" y="0" href="data:image/png;base64,"></image></svg> <div class="main">${escape(weather.temperature)} °C</div> <div class="mainsub">${escape(weather.locationName)}, ${escape(weather.lugar)}</div></div> <div class="card2"><div class="upper"><div class="humidity"><div class="humiditytext">Humidity<br>${escape(weather.humidity)}%</div> <svg xml:space="preserve" viewBox="0 0 30 30" height="30px" width="30px" y="0px" x="0px" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1" class="humiditysvg"><image href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAB4AAAAeCAMAAAAM7l6QAAAABGdBTUEAALGPC/xhBQAAACBjSFJN
                ...
                KHRFWHRkYXRlOnRpbWVzdGFtcAAyMDIzLTAyLTE2VDE4OjE5OjAwKzAwOjAwSbgwlgAAAABJRU5ErkJggg==" y="0" x="0" height="30" width="30" id="image0"></image></svg></div> <div class="air"><div class="airtext">Wind<br>${escape(weather.windSpeed)} Km/h</div> <svg class="airsvg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="30px" height="30px" viewBox="0 0 30 30" xml:space="preserve"><image id="image0" width="30" height="30" x="0" y="0" href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAB4AAAAeCAMAAAAM7l6QAAAABGdBTUEAALGPC/xhBQAAACBjSFJN
                  ...
                  LTE3VDA4OjA0OjIyKzAwOjAwmxUCVQAAAABJRU5ErkJggg=="></image></svg></div></div> <div class="lower"><div class="aqi"><svg class="aqisvg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 20 20" xml:space="preserve"><image id="image0" width="20" height="20" x="0" y="0" href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAMAAAC6V+0/AAAABGdBTUEAALGPC/xhBQAAACBjSFJN
                ...
                MjUrMDA6MDBiirAvAAAAAElFTkSuQmCC"></image></svg> <div class="aqitext">Latencia<br>${escape(weather.latencia)}</div></div> <div class="realfeel"><svg class="rfsvg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 20 20" xml:space="preserve"><image id="image0" width="20" height="20" x="0" y="0" href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAMAAAC6V+0/AAAABGdBTUEAALGPC/xhBQAAACBjSFJN
                ...
                Ut8AAAAASUVORK5CYII="></image></svg> <div class="pressuretext">Pressure<br>${escape(weather.pressure_mb)} mbar</div></div> <div class="card3" data-svelte-h="svelte-1y8ock1">Healthy</div></div></div></div></section> `;
    }(__value);
  }(weatherPromise)}`;
});
export {
