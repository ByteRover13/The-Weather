<script>
    ...
    async function obtenerValor() {
      const resultado = await getWeatherFrom(inputValue);
...
<head>
  <link rel="icon" href='../static/sun1.png' />
  <title>The weather </title>
</head>

{#await weatherData || weatherPromise then weather}
    <header class="header">
      <header class="header">
          <form on:submit|preventDefault={obtenerValor}>
            <div class="search">
              <input bind:value={inputValue} placeholder="Search Country ..." type="text" />
    ...
    <div class="cardm"> 
        <div class="card">
          ...
          <div class="main">{weather.temperature} °C</div>
          <div class="mainsub">{weather.locationName}, {weather.lugar}</div>
        </div>
      
        <div class="card2">
          <div class="upper">
            <div class="humidity">
              <div class="humiditytext">Humidity<br>{weather.humidity}%</div>
            ...
            <div class="air">
              <div class="airtext">Wind<br>{weather.windSpeed} Km/h</div>
          ...
          <div class="lower">
            <div class="aqi">
              ...
              <div class="aqitext">Latencia<br>{weather.latencia}</div>
            </div>
            ...
            <div class="realfeel">
              ...
              <div class="realfeeltext">Feels Like<br>{weather.feelsLike} °C</div>
            </div>
            ...
            <div class="pressure">
              ...
              <div class="pressuretext">Pressure<br>{weather.pressure_mb} mbar</div>
            </div>
            <div class="card3">
            Healthy
            </div>
